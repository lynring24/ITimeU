...
public class ItemProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.itto3.itimeu" will map to the
        ...
        // The content URI of the form "content://com.itto3.itimeu"/itimeu/#" will map to the
        // integer code {@link #ITEM_ID}. This URI is used to provide access to ONE single row
        // of the items table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.itto3.itimeu/itimeu/3" matches, but
        // "content://content://com.itto3.itimeu/itimeu" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case ITEM_ID:
                ...
                // For an example URI such as "content://com.itto3.itimeu/itimeu/3",
